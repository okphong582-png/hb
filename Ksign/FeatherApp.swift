...
struct FeatherApp: App {
	...
	private func _handleURL(_ url: URL) {
		if url.scheme == "highsign" || url.scheme == "ksign" {
            ...
            if url.pathExtension == "highsign" || url.pathExtension == "ksign" {
                UIAlertController.showAlertWithOk(title: .localized("Error"), message: .localized("HighSign certificate file is now unsupported, please use .p12 and .mobileprovision instead."))
            }
		}
	}
