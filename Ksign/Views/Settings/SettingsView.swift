...
extension SettingsView {
	...
	private func _feedback() -> some View {
		Section {
			NavigationLink(destination: AboutNyaView()) {
                Label(.localized("About HighSign"), systemImage: "info.circle")
            }
		}
	}
	...
	private func _directories() -> some View {
		NBSection(.localized("Misc")) {
			...
			Text(.localized("All of HighSign files except certificates are contained in the documents directory, here are some quick links to these."))
		}
	}
}
